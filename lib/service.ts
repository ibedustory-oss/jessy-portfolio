...
export const SERVICE: Record<Lang, ServiceContent> = {
  ja: {
    ...
    steps: [
      ...
      { n: '04', title: '渡す', desc: 'ドメインを設定して公開。更新のやり方をお渡しして、ここで一区切りです。' },
    ],
    priceTitle: '料金',
    ...
    plans: [
      ...
      },
      {
        ...
        features: ['戦略シートをSTP・4Pまで拡張', 'ページ構成の設計(最大10ページ)', '多言語(日英韓＋仏語監修)'],
        cta: '相談する',
        featured: true,
      },
      {
  ...
  ko: {
    ...
    steps: [
      ...
      { n: '04', title: '전달', desc: '도메인을 연결해 오픈합니다. 수정 방법을 드리고 여기서 한 단락 마칩니다.' },
    ],
    priceTitle: '요금',
    ...
    plans: [
      ...
      },
      {
        ...
        features: ['전략 시트를 STP·4P까지 확장', '페이지 구성 설계(최대 10페이지)', '다국어(한·일·영 + 불어 감수)'],
        cta: '상담하기',
        featured: true,
      },
      {
  ...
  en: {
    ...
    steps: [
      ...
      { n: '04', title: 'Hand over', desc: 'Domain set up, site live, and a guide to updating it. That closes the engagement.' },
    ],
    priceTitle: 'Pricing',
    ...
    plans: [
      ...
      },
      {
        name: 'Brand site',
        price: '¥200,000',
        unit: '+ (€800+) / up to 10 pages',
        desc: 'The face of your business, built from strategy up.',
        features: ['Strategy sheet extended to STP and the 4Ps', 'Page architecture (up to 10 pages)', 'Multilingual (JA/EN/KO, French edited)'],
        cta: 'Start a conversation',
        featured: true,
      },
      {
