...
export const SERVICE: Record<Lang, ServiceContent> = {
  ja: {
    ...
    finalSub: '事業の話を聞かせてください。いま何を先にやるべきかを整理して、メモにしてお渡しします。',
    finalCta: '相談する',
  ...
  ko: {
    ...
    finalSub: '사업 이야기를 들려주세요. 지금 무엇을 먼저 해야 할지 정리해서, 메모로 보내 드립니다.',
    finalCta: '상담하기',
  ...
  en: {
    ...
    finalSub: 'Tell me about it. I write up what to do first, and send you the notes.',
