...
export const SERVICE: Record<Lang, ServiceContent> = {
  ...
  ko: {
    ...
    sub: '웹사이트 제작사가 아닙니다. 무엇을 말할지 정하고, 사이트로 만들고, 오픈한 뒤의 숫자까지 함께 보는 마케팅 파트너입니다.',
    ctaPrimary: '상담하기',
    ctaSecondary: '작업물 보기',
    stats: [
    ...
    steps: [
      ...
      { n: '02', title: '언어화', desc: '진단부터 첫 수까지, 여덟 줄의 전략 시트로 정리해 합의합니다.' },
      { n: '03', title: '만들기', desc: '전략을 카피와 디자인으로 옮깁니다. 시안 이미지가 아니라 실제로 열리는 페이지로 확인합니다.' },
      { n: '04', title: '전달', desc: '도메인을 연결해 오픈합니다. 수정 방법도 함께 드립니다.' },
      { n: '05', title: '운영', desc: '오픈부터가 본편입니다. 북극성 숫자를 한 달에 한 번 같이 보고, 다음 수를 정합니다.' },
    ],
    priceTitle: '요금',
    ...
    plans: [
      ...
      },
      {
        ...
        price: '₩90,000',
        unit: '~ (€60~) / 월',
        desc: '오픈한 다음이 본편입니다. 숫자를 보면서 달마다 다음 수를 돌립니다.',
        features: ['월 1회 숫자 리뷰와 다음 수', '사이트 업데이트와 개선', 'SNS·콘텐츠 연계', '언제든 해지 가능'],
        cta: '상담하기',
        featured: true,
      },
    ],
