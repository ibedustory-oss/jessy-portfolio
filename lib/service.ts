  ...
  ja: {
    ...
    plans: [
      ...
      },
      {
        ...
        features: ['戦略シート(WHY・STP・4P)', '構成とコピー', '最大10ページ', '多言語', 'ドメインと公開'],
        cta: '相談する',
        featured: true,
      },
      {
  ...
  ko: {
    ...
    plans: [
      ...
      },
      {
        ...
        features: ['전략 시트(WHY·STP·4P)', '구성과 카피', '최대 10페이지', '다국어', '도메인 연결과 오픈'],
        cta: '상담하기',
        featured: true,
      },
      {
  ...
  en: {
    ...
    plans: [
      ...
      },
      {
        ...
        features: ['Strategy sheet (why, STP, 4Ps)', 'Structure and copy', 'Up to 10 pages', 'Multilingual', 'Domain and launch'],
        cta: 'Start a conversation',
        featured: true,
      },
      {
