...
export const EXTRA: Record<Lang, Extra> = {
  ...
  ko: {
    ...
    selfcheck: {
      eyebrow: '직접 써보기',
      title: 'Why는 이 네 가지에서\n나옵니다.',
      lead: 'Why는 떠오르는 게 아니라, 이 네 가지를 조사한 결과입니다. 적어보다가 안 채워지는 줄이 지금 가장 약한 자리입니다.',
      weakLabel: '흔한 답',
      ...
      rows: [
        {
          ...
          q: '누구를, 어떤 상태로 만들 것인가',
          weak: '건강해지고 싶은 사람',
          strong: '출산 1년째, 허리가 아파 아이를 못 안는 사람이 다시 안게 되는 것',
        },
        {
          k: '페인·게인',
          q: '왜 하필 우리가 하는가',
          weak: '필라테스를 좋아해서',
          strong: '내가 산후에 같은 통증으로 1년을 다녔다. 어떤 동작에서 나빠지는지 몸으로 안다',
        },
        {
          k: '시장',
          q: '그 사람은 몇 명이고, 늘고 있는가',
          weak: '필라테스 시장은 커지고 있다',
          strong: '이 구의 연간 출생 수는 ○건. 걸어올 수 있는 거리에 ○세대',
        },
        {
          k: '경쟁',
          q: '그 자리에 이미 누가 서 있는가',
          weak: '경쟁은 많지만 우리는 품질로 이긴다',
          strong: '근처 세 곳은 전부 그룹 수업이다. 산후 1:1은 아무도 하지 않는다',
        },
      ],
